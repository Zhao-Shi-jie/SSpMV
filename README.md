 ...
 * @LastEditTime: 2024-01-25 16:38:11
...
- **S-ELL** : Sliced ELL format. Multiple rows are packed into a row block for the ELL storage. Please click [here](chrome-extension://efaidnbmnnnibpcajpcglclefindmkaj/https://library.eecs.utk.edu/storage/files/ut-eecs-14-727.pdf) for more detailed implementation. **Parameters: chunk width C.**
