...
def train_MM_model(model_path, 
  ...
  print ("Finish MatNet Model Saving")
...
def train_and_get_res(training_data_list, val_data_list, label_suffix, label_nums):
  ...
  # 保存模型的目录
  model_path = "/data/lsl/SSpMV/models/MatNet.keras"
...
def evaluate_MM_Adapter(model_path, image_array_test, feat_array_test, label_array_test, test_data, eva_path, res_path):
  ...
  f_eva.write("MatNet Evaluating Acc:" + str(test_acc) + "\n")
  f_eva.close()
...
def test_model(test_data_list, label_suffix, label_nums):
  ...
  eva_path = "/data/lsl/SSpMV/models/prediction_result/MatNet/test_acc.txt"
  res_path = "/data/lsl/SSpMV/models/prediction_result/MatNet/predict_result.txt"
  ...
  metric_path = "/data/lsl/SSpMV/models/prediction_result/MatNet/metrics.res"
