...
def train_new_model_wide_deep(model_path,image_array,feat_array,label_array):
  combined_model = tf.keras.experimental.WideDeepModel(NewWide(), DeepModel())
...
def train_and_get_res():
  ...
  model_path = "/data1/xionghantao/data/JPDC/ml_models/new_wide_deep"
  ...
  eva_path = "/data1/xionghantao/data/JPDC/prediction_result/new_wide_deep/evaluate_acc.txt"
  res_path = "/data1/xionghantao/data/JPDC/prediction_result/new_wide_deep/predict_result.txt"
  evaluate_new_wide_deep_model(model_path, image_array, feat_array, label_array, test_data, eva_path, res_path)

  metric_path = "/data1/xionghantao/data/JPDC/prediction_result/new_wide_deep//metrics.res"
...
def train_and_get_res_ten_fold():
  ...
  res_dir = "/data1/xionghantao/data/JPDC/prediction_result/new_wide_deep"
  fold_num = 10
  for i in range(fold_num):
    ...
    model_path = "/data1/xionghantao/data/JPDC/ml_models/new_wide_deep_" + str(i)
